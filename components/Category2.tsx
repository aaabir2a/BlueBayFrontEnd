...
export default function Category2({
  ...
  const getProjectImage = (projectName: string) => {
    const matchingImage = portfolioImages.find(
      (img) => img.imageName.toLowerCase() === projectName.toLowerCase()
    );
    return matchingImage
      ? `${BASE_URL}${matchingImage.image}`
  ...
  return (
    <div>
      {showCategoryButtons && (
        <div className="sticky top-0 z-40 bg-white/80 backdrop-blur-sm py-4 shadow-sm">
