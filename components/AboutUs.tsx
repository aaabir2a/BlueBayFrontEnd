...
import { MessageCircle, FileText, Eye, Briefcase, Target, Lightbulb } from "lucide-react"
...
export default function AboutUs({
    ...
    const fetchAbouts = async () => {
      try {
        ...
        if (data && data.abouts) {
          ...
          const sortedAbouts = [...data.abouts].sort((a, b) => a.serial_number - b.serial_number)
  ...
  const fallbackCards = [
    {
      image: "https://lottie.host/5965db75-2656-423e-834e-8d0a0015d8d9/m83x7B9bfm.lottie",
      title: "Our Mission",
      description:
    ...
    {
      image: "https://lottie.host/e82ee24b-6b80-4dc8-b822-573988fec895/vJwjdYFU8f.lottie",
      title: "Our Plan",
      description:
    ...
    {
      image: "https://lottie.host/3a759236-1b5b-4326-85e4-2cddaf11f48c/cVUjlBUvms.lottie",
      title: "Our Vision",
      description:
    ...
    >
      ...
      <div className="container mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="max-w-4xl mx-auto text-gray-600 leading-relaxed">{description}</p>
        </div>
