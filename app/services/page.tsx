...
async function getAllServices(): Promise<ServiceSlider[]> {
  try {
    ...
    return (data.service_sliders || []).sort((a: ServiceSlider, b: ServiceSlider) => a.serial_number - b.serial_number)
  } catch (error) {
            ...
            {services.map((service) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 mb-4 line-clamp-3">{service.details}</p>
                  <Button asChild variant="outline" className="mt-2">
                    <Link href={`/services/${service.slug}`} className="inline-flex items-center">
